"""
NBT (Network Backup Tools) - Legacy Version 1.1

이 파일은 이전 개발 버전으로, 참고용으로 보관합니다.
현재는 core/backup.py를 사용하세요.

Update 내역:
- ver 1.0 (2025/09/15): Netmiko 라이브러리로 마이그레이션
- ver 1.1 (2025/09/15)
  - logging 기능 추가
  - run_nbt.bat 실행 시 배너 추가
  - 접속 재시도 횟수 수정 (MAX_RETRIES: 3 -> 5)
"""
...
# 로깅 설정
# =================================================================
log_file_path = os.path.join(FULL_FOLDER_PATH, 'create_nbt_run.log')
